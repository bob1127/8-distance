      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <button className="!text-transparent absolute top-1/2 -right-14 z-10 flex !h-[40px] !w-[40px] items-center justify-center rounded-full bg-white shadow-md hover:scale-110 transition rotate-180"></button>
