            ...
            <div className={styles.description}>
              ...
              <button className="group relative h-8 bg-transparent px-4 text-neutral-950">
                <span className="relative inline-flex overflow-hidden">
                  <div className="translate-y-0 skew-y-0 transition duration-500 group-hover:-translate-y-[110%] group-hover:skew-y-10">
                    <h2>{title}</h2>
                  </div>
                  <div className="absolute translate-y-[110%] skew-y-16 transition duration-500 group-hover:translate-y-0 group-hover:skew-y-0">
                    <h2>{title}</h2>
                  </div>
                </span>
              </button>
