...
export default function Content() {
  ...
  return (
    <div
      id="dark-section"
      className="pb-2  pt-20 sm:pt-[300px] mxa-w-[1920px] mx-auto md:pt-[360px] xl:pt-[380px] 2xl:pt-[350px] bg-[#222422] bg-left bg-no-repeat bg-cover py-8 2xl:px-[180px] xl:px-[180px] px-[40px] h-full  w-full flex flex-col justify-center"
    >
      <Section2 />
    ...
    <div className="flex justify-end flex-col">
      ...
      <div className="copy flex  flex-col lg:flex-row  border-t-1 border-white py-4">
        <div className="flex flex-col w-full lg:w-1/2  items-start justify-start">
          ...
          <p className="text-[.9rem]  text-gray-200 font-light">
            Copyright © {new Date().getFullYear()} 捌程室內設計
          </p>
        </div>
    ...
    <div className="shrink-0 gap-2 pt-20 w-full">
      ...
      <div className="middle flex flex-col lg:flex-row">
          ...
          <div className="grid grid-cols-2">
            <div className="flex py-0 sm:py-8 flex-col">
              <div className="flex flex-col">
                ...
                <div className="social-media-icon mb-1 mt-5 flex">
                  <svg
        ...
        <div className="w-full lg:w-[60%] pb-5  mt-10 sm:mt-0 flex flex-col lg:flex-row items-start lg:items-end justify-start lg:justify-end gap-4">
          ...
          {/* 右側資訊 */}
          <div className="sm:flex hidden  flex-col items-start lg:items-end justify-end w-full lg:w-auto"></div>
        </div>
      </div>
    </div>
  );
