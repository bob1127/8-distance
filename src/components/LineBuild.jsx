    ...
    >
      ...
      >
        ...
        <span className="relative grid place-content-center rounded-full aspect-square h-full text-[var(--icon--default)] [--icon--default:var(--color-primary)] [--icon--hovered:var(--color-white)]">
          <span className="--icon-bg absolute block size-full rounded-full inset-0 bg-[var(--icon-bg--default)] [--icon-bg--default:var(--color-light-gray)] [--icon-bg--hovered:var(--color-primary)]" />
        ...
        {/* ✅ 這個外框線用 SVG 畫，rect 必須有 x/y/width/height（百分比 OK） */}
        <svg
          className="--line absolute -top-px -left-px pointer-events-none"
          width="100%"
          height="100%"
          viewBox="0 0 100 100"
