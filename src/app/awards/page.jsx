...
export default function Home() {
 ...
 to-[#F5E6C5]"
      ...
      <section className="overflow-hidden  px-8 sm:px-0 w-[95%] md:w-[85%] mx-auto px-6">
      ...
      <section
        className="section-awards-info  px-8 sm:px-0 py-10 md:py-16"
